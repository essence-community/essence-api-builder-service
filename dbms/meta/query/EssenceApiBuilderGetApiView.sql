...
INSERT INTO s_mt.t_query (ck_id, ck_provider, ck_user, ct_change, cr_type, cr_access, cn_action, cv_description, cc_query)
 ...
 '{
method: ''GET'',
url: `${jt_provider_params.defaultGateUrl}/api-view?session=${jt_in_param.sess_session}&fetch=${jt_in_param.json.filter.jn_fetch}&offset=${jt_in_param.json.filter.jn_offset}&id=${jt_in_param.json.filter.id ? jt_in_param.json.filter.id : ""}`,
}')
