...
INSERT INTO s_mt.t_query (ck_id, ck_provider, ck_user, ct_change, cr_type, cr_access, cn_action, cv_description, cc_query)
 VALUES('EssenceApiBuilderGetApiPath', 'essence-api-builder', '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2021-02-07T18:53:52.053+0300', 'select', 'session', null, 'Список сервисов',
 '{
method: ''GET'',
url: `${jt_provider_params.defaultGateUrl}/api-view/path?session=${encodeURIComponent(encodeURIComponent(jt_in_param.sess_session))}&idApiView=${jt_in_param.json.master.id}&fetch=${jt_in_param.json.filter.jn_fetch}&offset=${jt_in_param.json.filter.jn_offset}&id=${jt_in_param.json.filter.id ? jt_in_param.json.filter.id : ""}`,
