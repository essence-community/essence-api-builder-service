...
If fso.FileExists(currDir & "\liquibase.init.properties") Then
    ...
    Wend
    commadLiquibase = currDir & "\..\liquibase\liquibase.bat --defaultsFile=liquibase.schema.properties --changeLogFile=db.changelog.schema.xml update"

    set WshExec2 = WshShell.Exec(commadLiquibase)
    Set TextStream2 = WshExec.StdOut
    While Not TextStream2.AtEndOfStream
        WScript.StdOut.Write TextStream2.ReadLine() & vbCrLf
    Wend
    WScript.Quit 0
End If
